...
public sealed class LocalizationService
{
    private readonly Dictionary<string, Dictionary<string, string>> _resources = new()
    {
        ["en-US"] = new Dictionary<string, string>
        {
            ...
            ["SettingsSubtitle"] = "Language, theme and AI opponent options.",
            ["AiOpponent"] = "AI Opponent",
            ["AiComingSoon"] = "Coming soon: Easy, Medium and Hard AI difficulty.",
            ["GameMode"] = "Game Mode",
            ["ModeLocalTwoPlayers"] = "Local Two Players",
            ["ModePlayerVsAi"] = "Player vs AI",
            ["AiDifficulty"] = "AI Difficulty",
            ["AiEasy"] = "Easy",
            ["AiMedium"] = "Medium",
            ["AiHint"] = "Easy AI plays random legal moves. Medium AI scores captures, den pressure and safety.",
            ["Cancel"] = "Cancel",
            ["Apply"] = "Apply",
            ["Close"] = "Close",
        ...
        ["zh-CN"] = new Dictionary<string, string>
        {
            ...
            ["ThemeSunflower"] = "向日葵",
            ["SettingsTitle"] = "设置",
            ["SettingsSubtitle"] = "语言、主题和 AI 对手选项。",
            ["AiOpponent"] = "AI 对手",
            ["AiComingSoon"] = "即将支持：简单、中等、困难三档 AI。",
            ["GameMode"] = "游戏模式",
            ["ModeLocalTwoPlayers"] = "本地双人",
            ["ModePlayerVsAi"] = "人机对战",
            ["AiDifficulty"] = "AI 难度",
            ["AiEasy"] = "简单",
            ["AiMedium"] = "中等",
            ["AiHint"] = "简单 AI 会随机选择合法走法。中等 AI 会综合吃子、进攻兽穴和安全性评分。",
            ["Cancel"] = "取消",
            ["Apply"] = "应用",
            ["Close"] = "关闭",
        ...
        ["zh-TW"] = new Dictionary<string, string>
        {
            ...
            ["ThemeSunflower"] = "向日葵",
            ["SettingsTitle"] = "設定",
            ["SettingsSubtitle"] = "語言、主題和 AI 對手選項。",
            ["AiOpponent"] = "AI 對手",
            ["AiComingSoon"] = "即將支援：簡單、中等、困難三檔 AI。",
            ["GameMode"] = "遊戲模式",
            ["ModeLocalTwoPlayers"] = "本地雙人",
            ["ModePlayerVsAi"] = "人機對戰",
            ["AiDifficulty"] = "AI 難度",
            ["AiEasy"] = "簡單",
            ["AiMedium"] = "中等",
            ["AiHint"] = "簡單 AI 會隨機選擇合法走法。中等 AI 會綜合吃子、進攻獸穴和安全性評分。",
            ["Cancel"] = "取消",
            ["Apply"] = "套用",
            ["Close"] = "關閉",
